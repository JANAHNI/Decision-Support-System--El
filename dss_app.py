...
if 'chat_history' not in st.session_state:
    st.session_state.chat_history = [
        {"role": "assistant", "content": "Hello Executive Manager. I am your AI Decision Support Assistant. Type a command below (e.g., *'Set budget to 500 lakhs'*, *'Increase residential subsidy to 40%'*, or *'Set coverage target to 95%'*) and I will automatically update parameters and re-run the ILP optimizer!"}
    ]
...
st.markdown('<div class="footer-note">🎓 MBA Decision Support Framework: Integer Linear Programming integrated with conversational executive AI for real-time strategic optimization.</div>', unsafe_allow_html=True)
